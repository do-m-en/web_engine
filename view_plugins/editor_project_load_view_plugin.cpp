...
class Editor_project_load_view_plugin final : public cpp_web_server::View_plugin_api
{
public:
    ...
    std::vector<std::tuple<std::string, std::string>> const& items) override
  {
    try
    {
      ...
      if(in)
      {
        ...
        return { cpp_web_server::Content_type::view, str };
      }
    }
    catch(...)
    {
...
extern "C" BOOST_SYMBOL_EXPORT Editor_project_load_view_plugin view_plugin;
Editor_project_load_view_plugin view_plugin;
